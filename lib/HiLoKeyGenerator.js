 ...
 * Generate a new document key for the provided entity type
 - entityName: (string) The name of the entities we are generating keys for
 * callback: (function(error, key)) Callback which provides the generated key
 */
 ...
 * Find the next available id, if we have used our range up, then fetch a new range from the server
 - entityName: (string) The name of the entities we are generating keys for
 * callback: (function(error, id)) Callback which provides the generated id
 */ 
 ...
 * entityName: (string) The name of the entities we are generating keys for
 * callback: (function(error)) Callback to indicate we have queried the server and are ready to generate more keys
 */
