 ...
 * database_name - Optionall pass the database name to have the server url created for you
...
Client.prototype.getDocument = function (key, options, callback) {
  ...
  self.httpClient.get(root + key, null, function (error, result) {
    ...
    return callback && callback(error, result, doc);
  });
};
...
Client.prototype.ensureDatabaseExists = function (name, callback) {
  ...
  self.getDocument(docId, { isRoot : true }, function (error, result, data) {
